/*
** matced32.c interface library for Matlab 6
** original by Dario Ringach
** modified for 32bit by JG Colebatch 
** 12.99: first 32 bit version
** 03.00: Added 1401 handle, reduced GetString buffer length
** 06.04: removed printf in cedOpen and cedReset
** 07.04: add cedOpenX
** 05.06: increase buffer size, cedLdX = v2, a little tidying of variables
** 12.06: v3: add cedLongsFrom1401, cedTransferFlags, cedSet/UnSetTransfer
                  cedGetTransData and cedGetTypeOf1401
   01.07: v3.1 change cedGetTransData to NOT free memory - does not work
				  with repeated cycles
   11.09: v4.0 return any error code from cedLdX, use Matlab7 mex.h and library files
   11.09: v4.1 can call U14WorkingSet (to avoid the -544 error)
   01.02.10: v4.2 allow larger transfers via cedToHost and cedTo1401
*/

#include <windows.h>
#include <stdio.h>
#include <string.h>
#include C:\Programme\MATLAB\R2008b\extern\include\mex.h"  
/*#include "d:\matced32\machine.h"*/
#include "C:\power1401Lang\WinSupp\Use1401.h"  //18.6.2004 version and .lib
...
const mxArray *prhs[];
{
    ...
    code = U14ToHost(sHand, (LPSTR) &data[0], 2*toRead, (DWORD)address, 0);
...
const mxArray *prhs[];
{
    ...
    address=address+2*offset;
    code = U14To1401(sHand, (LPSTR) &data[0], 2*toSend, address, 0);
    if (code != U14ERR_NOERROR)
		{
...
// usage:  matced32('cedSetTransfer',wArea,dwlength);
int nrhs;
const mxArray *prhs[];
{
	double *pr;
...
// call:  array=matced32('cedGetTransdata',wArea,dataLength,dataType);
int nrhs;
mxArray *plhs[];
const mxArray *prhs[];
{
